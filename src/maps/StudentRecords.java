...
*	 Above method - called createStudent - returns type Student
*	 accepts two parameters that are set to equal id and name (Strings
*   that exist within Student.java) - using this type of a method directly outside
*	 of your main method achieves the same result as creating a constructor (see
